  ...
  return (
    <div className={sidebarClassNames}>
      <div className={`flex gap-3 justify-between md:justify-normal items-center pt-8 ${isSidebarCollapsed ? "px-5" : "px-8"}`}>
        <div>Logo</div>
        <h1 className={`${isSidebarCollapsed ? "hidden" : "block"} font-extrabold text-2xl`}>JESAM</h1>
      ...
      <div className="grow mt-8">
        <SidebarLink href="/dashboard" icon={Layout} label="Dasboard" isCollapsed={isSidebarCollapsed}/>
        ...
        <SidebarLink href="/settings" icon={SlidersHorizontal} label="Dasboard" isCollapsed={isSidebarCollapsed}/>
        <SidebarLink href="/expenses" icon={CircleDollarSign} label="Expenses" isCollapsed={isSidebarCollapsed}/>
      </div>

      {/* FOOTER */}
      <div className={`${isSidebarCollapsed ? "hidden" : "block"} mb-10`}>
        <p className="text-center text-xs text-gray-500">&copy; 2026 JESAM</p>
      </div>
    </div>
  )
}
